...
MODULES = ["bitty_core", "alu", "arithmetic_unit", "control_unit", "logic_unit", "mux", "register"]
# MODULES.append("bitty_core", "alu", "arithmetic_unit", "control_unit", "logic_unit", "mux", "register")
